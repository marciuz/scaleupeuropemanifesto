    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="http://www.europeandigitalforum.eu"><img src="<?php echo FRONT_DOCROOT;?>/assets/img/logo_edf.png" /></a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="<?php echo FRONT_DOCROOT;?>" id="l-tracker">Startup Manifesto Tracker</a></li>
